...
if not defined DecoderKey (
    ...
    echo.
    echo Can support unscramble your logs?
...
if exist %PERUSER_START_MENU_PATH% (
    echo PerUser start menu shortcut exists at %PERUSER_START_MENU_PATH% > StartMenuShortcut.txt
) else (
    echo PerUser start menu shortcut does not exist at %PERUSER_START_MENU_PATH% > StartMenuShortcut.txt
)

if exist %PERMACHINE_START_MENU_PATH% (
    echo PerMachine start menu shortcut exists at %PERMACHINE_START_MENU_PATH% >> StartMenuShortcut.txt
) else (
    echo PerMachine start menu shortcut does not exist at %PERMACHINE_START_MENU_PATH% >> StartMenuShortcut.txt
)
